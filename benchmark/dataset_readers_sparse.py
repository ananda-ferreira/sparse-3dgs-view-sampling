...
# edits:
#   randome ply instead of read Colmap, moved to function
...
def readSparseColmapSceneInfo(path, images, depths, eval, train_test_exp, llffhold=8, n_views=0):
    ...
    #     # sampler = Sampler(viewCount = 3, train_cam_infos, recalibrate)
    #     # train_cam_infos = sampler.sample(sampleCount = 10) should return filtered cam_infos
